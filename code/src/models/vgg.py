...
def VGG9():
    return VGG("VGG9", node_num=None, input_dim=None, output_dim=None)


def VGG16():
    return VGG("VGG16", node_num=None, input_dim=None, output_dim=None)


def VGG19():
    return VGG("VGG19", node_num=None, input_dim=None, output_dim=None)
