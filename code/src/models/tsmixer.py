...
try:
    from extra.tsmixer.torchtsmixer.tsmixer import TSMixer as _TSMixer
...
class TSMixer(BaseModel):
    ...
    def __init__(self, num_channels, input_dim, output_dim, seq_len=12, horizon=12,
                 activation_fn="relu", num_blocks=2, dropout_rate=0.1, 
                 ff_dim=64, normalize_before=True, norm_type="batch", use_revin=False):
