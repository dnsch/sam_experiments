...
def get_config():
    parser = get_historic_average_config()

    args = parser.parse_args()

    args.model_name = "historic_average"
...
def run_experiments_on_data_list(
    ...
    for idx, data in enumerate(data_list):
        ...
        # TODO: maybe create a more generic model getter which returns model
        # based on args
        # Currently, we have a lot of repetition
