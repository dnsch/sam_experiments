...
import pdb
from src.models.time_series.formers.utils.masking import LocalMask
from src.models.time_series.formers.utils.fedformer_utils import get_filter
...
class MultiWaveletTransform(nn.Module):
    ...
    def __init__(
        self, ich=1, k=8, alpha=16, c=128, nCZ=1, L=0, base="legendre", attention_dropout=0.1
    ):
