...
class Autoformer_Engine(TorchEngine):
    """
    Autoformer pytorch trainer implemented in the sklearn fashion
    """
    ...
    def _create_decoder_time_features(self, x_mark_enc: torch.Tensor) -> torch.Tensor:
        ...
        # For future pred_len steps, we need to create time features
        # For simplicity, use zeros (could be improved with actual future time features)
