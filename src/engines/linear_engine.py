...
class Linear_Engine(TorchEngine):
    """
    Linear PyTorch trainer
    """
    ...
    def _revin_norm(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Linear input shape (after _prepare_batch): [batch, seq_len, channels]
    ...
    def _revin_denorm(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Linear output shape: [batch, pred_len, channels]
    ...
    def _prepare_batch(self, batch) -> Dict[str, torch.Tensor]:
        ...
        # Linear expects [batch, seq_len, channels]
